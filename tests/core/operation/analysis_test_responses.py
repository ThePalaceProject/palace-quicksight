...
def get_analysis_description_response(analysis_id):
    return {
        "ResponseMetadata": {
            ...
            "HTTPStatusCode": 200,
            "HTTPHeaders": {
                "date": "Tue, 05 Sep 2023 19:29:21 GMT",
        ...
        "Analysis": {
            ...
            "LastUpdatedTime": datetime(
                2023, 9, 1, 10, 6, 19, 376000, tzinfo=tzlocal()
            ),
            "Sheets": [
                {
...
def get_analysis_definition_response():
    return {
        "ResponseMetadata": {
            "RequestId": "dac531e6-fc4f-41a5-986e-4212c79e9c6c",
            "HTTPStatusCode": 200,
            "HTTPHeaders": {
                "date": "Tue, 05 Sep 2023 19:47:04 GMT",
                "content-type": "application/json",
                "content-length": "172259",
                "connection": "keep-alive",
        ...
        "Status": 200,
        "AnalysisId": "d954330e-7b80-4a4a-ab64-47f53d8eea38",
        "Name": "library",
...
def create_template_response():
    return {
        "ResponseMetadata": {
            "RequestId": "55aba51c-0052-4311-8fb3-b9433f0041da",
            "HTTPStatusCode": 202,
            "HTTPHeaders": {
                "date": "Tue, 05 Sep 2023 21:52:26 GMT",
                "content-type": "application/json",
                "content-length": "293",
                "connection": "keep-alive",
        ...
        "SourceEntity": {
            "SourceAnalysis": {
                ...
                "DataSetReferences": [
                    ...
                    {"DataSetPlaceholder": "patron_events", "DataSetArn": "ds_2_arn"},
                ],
            }
        },
    }
...
def describe_template_definition_response():
    return {
        "ResponseMetadata": {
            "RequestId": "c9ebc247-e7f7-4140-913c-2a1288ff43f6",
            "HTTPStatusCode": 200,
            "HTTPHeaders": {
                "date": "Tue, 05 Sep 2023 21:59:51 GMT",
                "content-type": "application/json",
            ...
            "DataSetConfigurations": [
                {
                    ...
                    "DataSetSchema": {
                        "ColumnSchemaList": [
                            ...
                            {"Name": "library_name", "DataType": "STRING"},
                        ]
                    },
...
def describe_data_set_1_response():
    return {
        "ResponseMetadata": {
            ...
            "HTTPStatusCode": 200,
            "HTTPHeaders": {
                "date": "Wed, 06 Sep 2023 00:02:50 GMT",
                "content-type": "application/json",
                "content-length": "4642",
                "connection": "keep-alive",
        ...
        "Status": 200,
        "DataSet": {
            "Arn": "arn:aws:quicksight:us-west-2:128682227026:dataset/e9e15c78-0193-4e4c-9a49-ed005569297d",
            ...
            "LastUpdatedTime": datetime(
                2023, 6, 7, 10, 5, 32, 640000, tzinfo=tzlocal()
            ),
            "PhysicalTableMap": {
                "25046cd8-e08f-41e0-8af8-5259b64499fd": {
                    "CustomSql": {
                        ...
                        "Columns": [
                            ...
                            {"Name": "open_access", "Type": "BIT"},
                            {"Name": "fiction", "Type": "BIT"},
...
def describe_data_set_2_response():
    return {
        "ResponseMetadata": {
            ...
            "HTTPStatusCode": 200,
            "HTTPHeaders": {
                "date": "Wed, 06 Sep 2023 00:07:58 GMT",
                "content-type": "application/json",
                "content-length": "2564",
                "connection": "keep-alive",
        ...
        "Status": 200,
        "DataSet": {
            "Arn": "arn:aws:quicksight:us-west-2:128682227026:dataset/86eb4ca5-9552-4ba6-8b1b-7ef1b9b40f78",
